...
public class account {
    ...
    public account(int ID, String dni, String email, String telefono, String direccion, String password, String token, int type, String company_id,String nombre) {
        this.ID = ID;
        this.dni = dni;
        this.email = email;
    ...
    public account(int ID, String dni, String email, String telefono, String direccion, String password, String token, int type, String company_id, String company_name, String company_phone, String company_address, String company_latitude, String company_longitude,String nombre, String company_ruc) {
        this.ID = ID;
        this.dni = dni;
        this.email = email;
        this.telefono = telefono;
